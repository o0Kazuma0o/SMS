        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <i class="bi bi-person-circle rounded-circle" style="font-size: 8rem;"></i>
              <h2><?= htmlspecialchars($_SESSION['name']); ?></h2>
              <h3><span><?= htmlspecialchars($_SESSION['role']); ?></span></h3>
            </div>
          </div>
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  <h5 class="card-title">Profile Details (WIP)</h5>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label ">First Name</div>
                    <div class="col-lg-9 col-md-8"><?= htmlspecialchars($user['first_name']); ?></div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?= htmlspecialchars($user['last_name']); ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label ">Academic Year</div>
                    <div class="col-lg-9 col-md-8"><?= htmlspecialchars($user['academic_year']); ?></div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?= htmlspecialchars($user['department']); ?></div>
                  </div>
