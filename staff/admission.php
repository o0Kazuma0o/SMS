...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['admission_id'], $_POST['status'])) {
  ...
  if ($status === 'Temporarily Enrolled') {
    ...
    if ($admissionData) {
      ...
      $form138 = isset($_POST['form138']) ? ($_POST['form138'] === 'on' ? 'Submitted' : 'To Be Followed') : NULL;
      $form137 = isset($_POST['form137']) ? ($_POST['form137'] === 'on' ? 'Submitted' : 'To Be Followed') : NULL;
      $goodMoral = isset($_POST['good_moral']) ? ($_POST['good_moral'] === 'on' ? 'Submitted' : 'To Be Followed') : NULL;
      $birthCertificate = isset($_POST['birth_certificate']) ? ($_POST['birth_certificate'] === 'on' ? 'Submitted' : 'To Be Followed') : NULL;
      $brgyClearance = isset($_POST['brgy_clearance']) ? ($_POST['brgy_clearance'] === 'on' ? 'Submitted' : 'To Be Followed') : NULL;
