...
if (isset($_GET['id'])) {
    $id = intval($_GET['id']);
    $stmt = $conn->prepare("SELECT a.*, d.department_name AS department_name FROM sms3_admissions_data a LEFT JOIN sms3_departments d ON a.department_id = d.id WHERE a.id = ?");
